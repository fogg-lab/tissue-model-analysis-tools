...
def parse_zproj_args(arg_defaults: dict[str, Any]) -> argparse.Namespace:
    ...
    parser.add_argument("-o", "--order", type=int, default=1, choices=[0, 1], help=f"Interpretation of Z stack order. 0=Ascending, 1=Descending. For Z stack of size k: -o 0 means Z0 is bottom of well while -o 1 means Z0 is top of well. If no argument supplied, defaults to 1=Descending.")
